...
After initialization, the repository should contain Spec Kit runtime assets, including `.specify`.
...
After installation, run a minimal validation using a sample PBI.
