...
- Inspect evidence files under the code root and under the active feature folder, if available.
...
- Delivery layout: <layout=ok>
- Previously delivered PBIs: <value of delivered-pbis excluding the current PBI, or none>

### Snapshot Notice

This document is a dated snapshot of the implemented reality at generation time. It is not a living document and must never be updated by a later PBI. Later PBIs may modify the files listed here; those changes are documented in their own delivery documentation.
